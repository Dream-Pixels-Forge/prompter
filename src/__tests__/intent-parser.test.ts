...
describe('extractKeywords', () => {
  ...
  it('extracts meaningful keywords, filtering stop words and short words', () => {
    ...
    expect(extractKeywords('create a blog post about writing')).toEqual(['create', 'blog', 'post', 'writing']);
  });
  ...
  it('removes punctuation and stop words, keeps content words > 2 chars', () => {
    ...
    expect(extractKeywords('Hello, world! This is a test.')).toEqual(['hello', 'world', 'test']);
  });
