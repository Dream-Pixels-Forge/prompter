...
export const openaiFramework: Framework = {
  ...
  sections: [
    ...
    },
    {
      ...
      defaultContent: 'Professional, clear, and direct. You communicate with {audience} and prioritize actionable insights.',
    },
    {
      key: 'goal',
      label: 'Goal',
